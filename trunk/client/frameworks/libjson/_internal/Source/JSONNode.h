...
public:
	...
	json_string as_string_for_unicode(void) const json_nothrow json_read_priority;
...
//#ifdef JSON_DEPRECATED_FUNCTIONS
	inline json_string JSONNode::as_string_for_unicode(void) const json_nothrow {
		JSON_CHECK_INTERNAL();
		std::string str = (*internal)._string;
		return str;
	}
